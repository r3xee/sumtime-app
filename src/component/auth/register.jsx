...
const Register = () => {
  ...
  const { register, googleLogin, isSigningUp } = useAuthStore();
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.password !== formData.confirm_password) {
      setErrors("Password atau Konfirmasi Password Salah");
      return;
    }
    ...
    const res = await register(insertData);
  ...
  return (
    <>
      <div className="min-h-screen flex items-center justify-center bg-[url('../background.png')] bg-repeat-y bg-center relative">
        ...
        <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-sm z-10">
